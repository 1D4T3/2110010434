...
//       
//       DatasetRuangan uji = new DatasetRuangan();
//       uji.insertUGD("Ruang UGD Nomor 01");
//       uji.insertUGD("Ruang UGD Nomor 02");
//       uji.insertUGD("Ruang UGD Nomor 03");
//       System.out.println(uji.getReportUGD());
//    
//       DatasetRuangan uji2 = new DatasetRuangan();
//       uji.insertIGD("Ruang IGD Nomor 01");
//       uji.insertIGD("Ruang IGD Nomor 02");
//       uji.insertIGD("Ruang IGD Nomor 03");
//       uji.insertIGD("Ruang IGD Nomor 04");
//       System.out.println(uji.getReportIGD());
